...
CREATE TABLE `articulo` (
  ...
  `tiempoPreparacionMinutos` int DEFAULT NULL,
...
INSERT INTO `articulo` VALUES (1,'ABC123','Silla',19.99,5,30),(2,'DEF456','Mesa',29.99,7.5,45),(3,'GHI789','Cuadro',14.99,3,20);
...
CREATE TABLE `cliente` (
  ...
  `calcAnual` float DEFAULT NULL,
  `descuentoEnv` float DEFAULT NULL,
  PRIMARY KEY (`idCliente`),
  UNIQUE KEY `email` (`email`),
  CONSTRAINT `cliente_chk_1` CHECK ((`tipoCliente` in (_utf8mb4'estandar',_utf8mb4'premium')))
...
INSERT INTO `cliente` VALUES (1,'1','1','1','1','estandar',0,0),(2,'2','2','2','2','premium',0,0),(3,'cliente1@example.com','Juan Pérez','Calle A, Nº 123','12345678A','estandar',NULL,NULL),(4,'cliente2@example.com','María Rodríguez','Calle B, Nº 456','87654321B','premium',30,0.2),(5,'cliente3@example.com','Roberto Gómez','Calle C, Nº 789','56789012C','estandar',NULL,NULL),(7,'11','11','11','11','estandar',NULL,NULL),(8,'22','22','22','22','premium',1,1),(9,'3','3','3','3','premium',1,1),(10,'33','33','33','33','premium',30,0.2),(11,'5','5','5','5','estandar',NULL,NULL),(12,'6','6','6','6','premium',30,0.2);
...
CREATE TABLE `pedido` (
  ...
  `idClaseArticulo` varchar(255) DEFAULT NULL,
  `cantidad` int DEFAULT NULL,
  `fechaHoraPedido` datetime DEFAULT NULL,
...
INSERT INTO `pedido` VALUES (25,1002,2,'2',24,'2023-02-20 14:45:00'),(35,1003,3,'3',35,'2023-03-10 10:15:00'),(151,1001,11,'151',11,'2023-01-15 08:30:00'),(152,1111,0,'ABC123',1,'2023-11-30 00:40:38'),(153,1,1,'ABC123',5,'2023-11-30 00:54:51');
...
-- Dump completed on 2023-11-30  1:01:57
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
...
LOCK TABLES `cliente` WRITE;
/*!40000 ALTER TABLE `cliente` DISABLE KEYS */;
INSERT INTO `cliente` VALUES (1,'cliente1@email.com','Juan Pérez','Calle A, Ciudad','12345678A'),(2,'cliente2@email.com','María Rodríguez','Avenida B, Pueblo','98765432B'),(3,'cliente3@email.com','Carlos Gómez','Plaza C, Villa','56789012C');
/*!40000 ALTER TABLE `cliente` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `clienteestandar` (
  `idClienteEstandar` int NOT NULL AUTO_INCREMENT,
  `idCliente` int DEFAULT NULL,
  `tipoCliente` varchar(50) DEFAULT NULL,
  `calcAnual` float DEFAULT NULL,
  `descuentoEnv` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`idClienteEstandar`),
  KEY `idCliente` (`idCliente`),
  CONSTRAINT `clienteestandar_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `clienteestandar` VALUES (1,1,'normal',4.5,'0.1'),(2,2,'normal',3.2,'0.05'),(3,3,'normal',5,'0.2');
...
CREATE TABLE `clientepremium` (
  ...
  KEY `idCliente` (`idCliente`),
  CONSTRAINT `clientepremium_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `clientepremium` VALUES (1,1,'Premium Oro',7.8,'0.15'),(2,2,'Premium Plata',6.3,'0.1'),(3,3,'Premium Diamante',9.5,'0.2');
...
CREATE TABLE `pedido` (
  `idPedido` int NOT NULL AUTO_INCREMENT,
  `numeroPedido` int DEFAULT NULL,
  `idClientePremium` int DEFAULT NULL,
  `idClaseArticulo` int DEFAULT NULL,
  `cantidad` int DEFAULT NULL,
  `fechaHoraPedido` datetime DEFAULT NULL,
  PRIMARY KEY (`idPedido`),
  KEY `idClientePremium` (`idClientePremium`),
  KEY `idClaseArticulo` (`idClaseArticulo`),
  CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`idClientePremium`) REFERENCES `clientepremium` (`idClientePremium`),
  CONSTRAINT `pedido_ibfk_2` FOREIGN KEY (`idClaseArticulo`) REFERENCES `articulo` (`idArticulo`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `pedido` WRITE;
/*!40000 ALTER TABLE `pedido` DISABLE KEYS */;
INSERT INTO `pedido` VALUES (1,1001,1,1,1,'2023-01-15 08:30:00'),(2,1002,2,2,2,'2023-02-20 14:45:00'),(3,1003,3,3,3,'2023-03-10 10:15:00');
/*!40000 ALTER TABLE `pedido` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-11-28 19:23:42',NULL),('diagnostics.include_raw','OFF','2023-11-28 19:23:42',NULL),('ps_thread_trx_info.max_length','65535','2023-11-28 19:23:42',NULL),('statement_performance_analyzer.limit','100','2023-11-28 19:23:42',NULL),('statement_performance_analyzer.view',NULL,'2023-11-28 19:23:42',NULL),('statement_truncate_len','64','2023-11-28 19:23:42',NULL);
...
-- Dump completed on 2023-11-30  1:01:58
