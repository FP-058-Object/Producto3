...
public class MysqlArticuloDao implements ArticuloDao{
    ...
    final String UPDATE = "UPDATE articulo SET codigo= ?, descripcion= ?, precioVenta= ? ,gastosEnvio= ?, tiempoPreparacionMinutos= ? WHERE idArticulo = ?";
    ...
    //final String GETONE = "SELECT  idArticulo,codigo, descripcion, precioVenta,gastosEnvio, tiempoPreparacionMinutos FROM articulo WHERE codigo = ?";
    ...
    public void modificar(Articulo a)throws DAOException {
       ...
       try{
           ...
           stament.setDouble(4,a.getGastosEnvio());
           stament.setInt(5,a.getTiempoPreparacionMinutos());
            stament.setInt(6, a.getIdArticulo());
           if(stament.executeUpdate()==0){
              throw new DAOException("Ha habido un error al guardar el registro.");
           }
           else {
    ...
    public void eliminar(Articulo a)throws DAOException{
       ...
       try{
           ...
           stament.setLong(1, (long)a.getIdArticulo());
