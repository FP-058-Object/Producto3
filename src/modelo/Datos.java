...
public class Datos {
    ...
    public ArrayList<Pedido> obtenerPedidosPendientesCliente(Cliente cliente) {
        ...
        public Pedido crearPedidoNuevo(int numero, Cliente cliente, Articulo articulo, int cantidad, Date fecha) {
            Pedido nuevoPedido = new Pedido(numero, cliente, articulo, cantidad, fecha); 
            listaPedidos.agregar(nuevoPedido); // Agrega el nuevo pedido a la lista de pedidos
            return nuevoPedido;
        }
    ...
    private void cargarDatosEjemplo() {
        ...
        ClienteEstandar cliente1 = new ClienteEstandar("cliente1@example.com", "Cliente1", "Dirección1", "NIF1");
