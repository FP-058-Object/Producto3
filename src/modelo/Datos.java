...
public class Datos {
    ...
    //Gestion Articulos
        // Agregar un articulo a la lista de articulos
    public Articulo anadirArticulo(String codigo, String descripcion, double precioVenta, double gastosEnvio, int tiempoPreparacionMinutos) {
        ...
        System.out.println("Articulo creado: " + nuevoArticulo.toString());
        return nuevoArticulo;
    }
        // Obtener una lista de todos los articulos
    ...
    public Cliente agregarClienteEstandar(String email, String nombre, String domicilio, String nif) {
        ...
        System.out.println("Has anadido al cliente Estandar: " + nuevoClienteEstandar.toString());
    ...
    public Cliente agregarClientePremium(String email, String nombre, String domicilio, String nif) {
        ...
        System.out.println("Has anadido al cliente Estandar: " + nuevoClientePremium.toString());
    ...
    public ArrayList<Cliente> obtenerClientesEstandar() {
        ...
        public boolean eliminarPedido(int numeroPedido) {
            for (Pedido pedido : listaPedidos.obtenerDatosLista()) {
                if (pedido.getNumeroPedido() == numeroPedido && !pedido.pedidoEnviado()) {
                    ...
                    System.out.println("El pedido se elimino exitosamente");
                    return true; 
                }
            }
            System.out.println("El pedido no se encontro o ya ha sido enviado");
            return false;
        }
        ...
        public Pedido crearPedidoNuevo(int numero, Cliente cliente, Articulo articulo, int cantidad, Date fecha) {
            ...
            System.out.println("Pedido creado con exito /n" + pedidoNuevo.toString());
            return pedidoNuevo;
        }
    ...
    private void cargarDatosEjemplo() {
        ...
        ClienteEstandar cliente1 = new ClienteEstandar("111", "Cliente1", "Direccion1", "NIF1");
        ClienteEstandar cliente2 = new ClienteEstandar("cliente2@example.com", "Cliente2", "Direccion2", "NIF2");
        ClienteEstandar cliente3 = new ClienteEstandar("cliente3@example.com", "Cliente3", "Direccion3", "NIF3");
        ClienteEstandar cliente4 = new ClienteEstandar("cliente4@example.com", "Cliente4", "Direccion4", "NIF4");
        ClienteEstandar cliente5 = new ClienteEstandar("cliente5@example.com", "Cliente5", "Direccion5", "NIF5");
        ...
        Articulo articulo1 = new Articulo("A001", "Articulo 1", 10.0, 5.0, 30);
        Articulo articulo2 = new Articulo("A002", "Articulo 2", 15.0, 6.0, 40);

        // Agregar articulos a la lista de articulos
        ...
        Date fechaAnterior1 = new Date(System.currentTimeMillis() - 86400000); // Un dia antes
        Pedido pedido6 = new Pedido(6, cliente1, articulo2, 2, fechaAnterior1);
        Date fechaAnterior2 = new Date(System.currentTimeMillis() - 172800000); // Dos dias antes
        Pedido pedido7 = new Pedido(7, cliente2, articulo1, 3, fechaAnterior2);
        Date fechaAnterior3 = new Date(System.currentTimeMillis() - 259200000); // Tres dias antes
        Pedido pedido8 = new Pedido(8, cliente1, articulo1, 4, fechaAnterior3);
        Date fechaAnterior4 = new Date(System.currentTimeMillis() - 345600000); // Cuatro dias antes
        Pedido pedido9 = new Pedido(9, cliente2, articulo2, 1, fechaAnterior4);
        Date fechaAnterior5 = new Date(System.currentTimeMillis() - 432000000); // Cinco dias antes
